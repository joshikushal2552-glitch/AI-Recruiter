...
4. Use a hosted PostgreSQL provider (Neon, Supabase, or Vercel Postgres).
5. Deploy — Vercel will run `prisma generate` and `next build` automatically.
...
| `NEXTAUTH_URL` | App URL (production domain) |
